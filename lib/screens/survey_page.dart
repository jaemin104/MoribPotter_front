...
class _SurveyPageState extends State<SurveyPage> {
  final List<Map<String, dynamic>> questions = [
    {
      "question": "당신이 가장 자랑스럽게 여기는 성격적 강점은 무엇입니까?",
      "choices": [
    ...
    {
      "question": "팀 프로젝트에서 당신은 어떤 역할을 선호합니까?",
      "choices": [
        {"text": "리더가 되어 팀을 이끈다.", "house": "slytherin"},
        {"text": "팀원들에게 열정과 동기를 불어넣는다.", "house": "gryffindor"},
        {"text": "팀 내에서 조화를 유지하고 다른 사람을 지원한다.", "house": "hufflepuff"},
        {"text": "창의적이고 효율적인 아이디어를 제안한다.", "house": "ravenclaw"}
      ]
    },
    {
      "question": "호그와트의 비밀 통로에서 길을 잃었다면 당신은 무엇을 하겠습니까?",
      "choices": [
    ...
    {
      "question": "마법 세계에서 당신이 가장 먼저 배우고 싶은 마법은 무엇입니까?",
      "choices": [
        {"text": "자연을 이해하고 활용하는 마법", "house": "ravenclaw"},
        {"text": "방어 마법으로 나와 다른 사람을 보호하기", "house": "gryffindor"},
